...
urlpatterns = [
    ...
    path('persona/editar/<int:id>/', views.persona_editar, name='persona_editar'),
    path('persona/borrar/<int:id>/', views.persona_borrar, name='persona_borrar'),
    path('tecnico/', views.tecnico_index, name='tecnico_index'),
    path('tecnico/crear/', views.tecnico_crear, name='tecnico_crear'),
    path('tecnico/<int:id>/', views.tecnico_detalle, name='tecnico_detalle'),
    path('tecnico/editar/<int:id>/', views.tecnico_editar, name='tecnico_editar'),
